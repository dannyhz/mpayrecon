 ...
 */
@Component
public class ZJChannelBill extends AbstractChannelBill {

    @Override
    protected void doinit() {
        super.setChannelName("中金");
        super.setChannelCode(PropertyUtils.getValue("com.sunrun.bill.zj.channelCode"));
        super.setControlFlag(PropertyUtils.getValue("com.sunrun.bill.zj.controlFlag"));
        super.setLocalfilepath(PropertyUtils.getValue("com.sunrun.bill.bank.local.zjfilepath"));
        super.setFileName(PropertyUtils.getValue("com.sunrun.bill.zj.fileName"));
        super.setSftpPath(PropertyUtils.getValue("com.sunrun.bill.sftp.zj.filepath"));
        ...
        try {
            ...
            if (!StringUtils.isEmpty(trxIdFlag) && trxIdFlag.equals(_trx_id.substring(0, 1))
                ...
                resStr = (_trx_id + // 流水号trx_id
                    "," + StringUtils.fatch(unHandleStr, 3, ",") + "," + StringUtils.fatch(unHandleStr, 4, ","))
                        .getBytes();// 金额
            }
        } catch (Exception e) {
        ...
        try {
            if (fileList != null && fileList.size() > 0) {
                for (byte[] bill : fileList) {
                    ...
                    billDetailDO.setChannelOrderStatus(_zj_status);
                    ...
                    if (dbMap.containsKey(keyObj)) {
                        ...
                        if ((("00".equals(_status) && ("30").equals(_zj_status))
                            || ("30".equals(_status)) && "30".equals(_zj_status))) {
                            // 比对金额，相同，则认为成功
                        ...
                        else if (("99".equals(_status) && "30".equals(_zj_status))
                            || ("00".equals(_status) && "40".equals(_zj_status))) {
                            // 错账处理--状态不一致
                        ...
                        } else if (("30".equals(_status)) && "40".equals(_zj_status)) {
