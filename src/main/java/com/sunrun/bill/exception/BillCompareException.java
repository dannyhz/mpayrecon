...
public class BillCompareException extends Exception {

	private static final long serialVersionUID = 424926678425962289L;
	...
	public BillCompareException(String paramString) {
		super(paramString);
		this.message = paramString;
		this.stackTrace = paramString;
	}
	
	public BillCompareException(Throwable paramThrowable) {
	...
	public BillCompareException(String paramString, Throwable paramThrowable) {
